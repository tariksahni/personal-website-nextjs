              ...
              <div className="home-page-details">
                  ...
                  <div className="intro-section">
                      ...
                      <div className="about-me-container yellow-color-background">
                          <a href={MyResume} download={'Tarik_Sahni_FE_Resume'}><span
                              className="white-color upper-case fs-2 fw-medium">Download Resume &nbsp; 💻</span></a>
                      </div>
                      <div className="about-me-container mt-2 yellow-color-background">
                          <span className="white-color upper-case fs-2 fw-medium">Let's connect on blockchain Ξ</span>
                      </div>
                  </div>
              </div>
          </div>
